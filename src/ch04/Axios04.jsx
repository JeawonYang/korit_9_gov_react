        ...
        <div>
            <div>
                <input type="text"
                    ...
                    onKeyDown={(e) => handleRegisterInputNextFocusOnKeyDown(e, registerInputRef.password)} /></div>
            <div>
                <input type="text"
                    ...
                    onChange={handleRegisterInputOnChange}
                    onKeyDown={(e) => handleRegisterInputNextFocusOnKeyDown(e, registerInputRef.name)} /></div>
            <div>
                <input type="text"
                    ...
                    onChange={handleRegisterInputOnChange}
                    onKeyDown={(e) => handleRegisterInputNextFocusOnKeyDown(e, registerInputRef.email)} /></div>
            <div>
                <input type="text"
                    ...
                    onChange={handleRegisterInputOnChange}
                    onKeyDown={(e) => handleRegisterInputNextFocusOnKeyDown(e, registerInputRef.role1)} /></div>
            <div>
                <input type="text"
                    ...
                    onChange={handleRegisterInputOnChange}
                    onKeyDown={(e) => handleRegisterInputNextFocusOnKeyDown(e, registerInputRef.role2)} /></div>
            <div>
                <input type="text"
